                ...
                (a = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.cardTemplate =
                            '<div class="jp-card-container"><div class="jp-card"><div class="jp-card-front" hidden="true"><div class="jp-card-logo jp-card-elo"><div class="e">e</div><div class="l">l</div><div class="o">o</div></div><div class="jp-card-logo jp-card-visa">Visa</div><div class="jp-card-logo jp-card-visaelectron">Visa<div class="elec">Electron</div></div><div class="jp-card-logo jp-card-mastercard">Mastercard</div><div class="jp-card-logo jp-card-maestro">Maestro</div><div class="jp-card-logo jp-card-amex"></div><div class="jp-card-logo jp-card-discover">discover</div><div class="jp-card-logo jp-card-unionpay">UnionPay</div><div class="jp-card-logo jp-card-dinersclub"></div><div class="jp-card-logo jp-card-hipercard">Hipercard</div><div class="jp-card-logo jp-card-troy">troy</div><div class="jp-card-logo jp-card-dankort"><div class="dk"><div class="d"></div><div class="k"></div></div></div><div class="jp-card-logo jp-card-jcb"><div class="j">J</div><div class="c">C</div><div class="b">B</div></div><div class="jp-card-lower"><div class="jp-card-number jp-card-display" hidden="true"></div></div></div></div></div>'),
                        ...
                        (t.prototype.render = function () {
                            ...
                            if (
                                ...
                                this.options.width && ((r = n(this.options.cardSelectors.cardContainer)[0]), (e = parseInt(r.clientWidth || window.getComputedStyle(r).width))),
        ...
        (function (e) {
            (function () {
                ...
                (n = t(1)),
                    ...
                    (p = function (r) {
                        var e, t;
                        if (((e = r.target), (t = n.val(e)), !r.meta && 8 === r.which && !j(e)))
                            return /\d\s$/.test(t)
                    ...
                    (l = function (r) {
                        var e, t;
                        if (!r.metaKey && ((e = r.target), (t = n.val(e)), 8 === r.which && !j(e)))
                            return /\d(\s|\/)+$/.test(t)
                                ? (r.preventDefault(), n.val(e, t.replace(/\d(\s|\/)*$/, "")), n.trigger(e, "change"))
                                : /\s\/\s?\d?$/.test(t)
                    ...
                    (x = function (r) {
                        return function (e) {
                            var t, a, i, d, c;
                            if (((d = e.target), (a = String.fromCharCode(e.which)), /^\d+$/.test(a) && !j(d)))
